          ...
          return Container(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 8.0,right: 8, left: 15, bottom: 5),
                  child: Align(
                      alignment: Alignment.topLeft,
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: 8.0,right: 8, left: 15),
                  child: Align(
                      alignment: Alignment.topLeft,
                      child: Text(product.details.toString(),
                        style: TextStyle(
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Align(
              alignment: Alignment.topLeft,
              child: Text('Your Order Essentials...',
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 20,
                ),
